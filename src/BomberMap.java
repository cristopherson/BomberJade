...
/**
 * File: BomberMap.java Copyright: Copyright (c) 2001
 *
 * @author Sammy Leong
 * @version 1.0
 */
        ...
        try {
            ...
            for (int t = 0; t < 7; t++) {
                for (int i = 0; i < 8; i++) {
                    ...
                    if (t == FIRE_CENTER) {
                        str += "C";
                    } else if (t == FIRE_VERTICAL) {
                        str += "V";
                    } else if (t == FIRE_NORTH) {
                        str += "N";
                    } else if (t == FIRE_HORIZONTAL) {
                        str += "H";
                    } else if (t == FIRE_EAST) {
                        str += "E";
                    } else if (t == FIRE_WEST) {
                        str += "W";
                    } else if (t == FIRE_SOUTH) {
                        str += "S";
                    }
                    if (t == FIRE_BRICK) {
                        fireImages[t][i] = null;
                ...
                if (southStop == 0) {
                    if (((_y >> shiftCount) + i) < 17) {
                        ...
                        if (grid[_x >> shiftCount][(_y >> shiftCount) + i] != WALL) {
                             ...
                             */
                            {
                                southStop = grid[_x >> shiftCount][(_y >> shiftCount) + i];
                            }
                            /**
                             * increase fire chain
                             */
                ...
                if (northStop == 0) {
                    if (((_y >> shiftCount) - 1) >= 0) {
                        ...
                        if (grid[_x >> shiftCount][(_y >> shiftCount) - i] != WALL) {
                             ...
                             */
                            {
                                northStop = grid[_x >> shiftCount][(_y >> shiftCount) - i];
                            }
                            /**
                             * increaes fire chain
                             */
                ...
                if (eastStop == 0) {
                    if (((_x >> shiftCount) + i) < 17) {
                        ...
                        if (grid[(_x >> shiftCount) + i][_y >> shiftCount] != WALL) {
                             ...
                             */
                            {
                                eastStop = grid[(_x >> shiftCount) + i][_y >> shiftCount];
                            }
                            /**
                             * increase fire chain
                             */
                ...
                if (westStop == 0) {
                    if (((_x >> shiftCount) - i) >= 0) {
                        ...
                        if (grid[(_x >> shiftCount) - i][_y >> shiftCount] != WALL) {
                             ...
                             */
                            if (grid[(_x >> shiftCount) - i][_y >> shiftCount] != NOTHING) /**
                             * then create a tail fire there
                             */
                            {
                                westStop = grid[(_x >> shiftCount) - i][_y >> shiftCount];
                            }
                            /**
                             * increase fire chain
                             */
            ...
            for (int i = 1; i <= northBlocks; i++) {
                ...
                if (i == northBlocks) {
                     ...
                     */
                        ...
                        createFire(_x, _y - (i * size), owner, FIRE_NORTH);
                    }
                } /**
                 * if it's not a tail then create a normal fire
                 */
                else {
                    createFire(_x, _y - (i * size), owner, FIRE_VERTICAL);
                }
            }
            for (int i = 1; i <= southBlocks; i++) {
                ...
                if (i == southBlocks) {
                     ...
                     */
                        ...
                        createFire(_x, _y + (i * size), owner, FIRE_SOUTH);
                    }
                } /**
                 * if it's not a tail then create a normal fire
                 */
            ...
            for (int i = 1; i <= eastBlocks; i++) {
                ...
                if (i == eastBlocks) {
                     ...
                     */
                        ...
                        createFire(_x + (i * size), _y, owner, FIRE_EAST);
                    }
                } /**
                 * if it's not a tail then create a normal fire
                 */
            ...
            for (int i = 1; i <= westBlocks; i++) {
                ...
                if (i == westBlocks) {
                     ...
                     */
                        ...
                        createFire(_x - (i * size), _y, owner, FIRE_WEST);
                    }
                } /**
                 * if it's not a tail then create a normal fire
                 */
