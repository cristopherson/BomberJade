...
/**
 * File: BomberConfigDialog Copyright: Copyright (c) 2001
 *
 * @author Sammy Leong
 * @version 1.0
 */
/**
 * This class shows a dialog which allows the user to configure the game.
 */
         ...
         */
            ...
            for (i = 0; i < 4; ++i) {
                for (j = 0; j < 5; ++j) {
                     ...
                     */
                    if (evt.getSource().equals(buttons[i][j])) {
                        found = true;
                    }
                    if (found) {
                        break;
