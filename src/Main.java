    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            if (args[i].startsWith("-l")) {
                if (args[i].substring(2).equals("System")) {
                    lookAndFeel = 0;
                } else if (args[i].substring(2).equals("Metal")) {
                    lookAndFeel = 1;
                } else if (args[i].substring(2).equals("Windows")) {
                    lookAndFeel = 2;
                } else if (args[i].substring(2).equals("Mac")) {
                    lookAndFeel = 3;
                } else if (args[i].substring(2).equals("Motif")) {
                    lookAndFeel = 4;
                }
            }
        }
